        ...
        function updateSlider() {
            ...
            // Add the 'inactive' class to all other images
            ...
            // Set the opacity of all background divs to 0
            backgrounds.forEach((background) => {
                background.style.opacity = 0;
            });

            // If the current image is active, set the corresponding background div to 1
